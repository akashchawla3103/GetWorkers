...
echo  $name ,$email ,$mobile,  $birthdate,  $gender, $address;
...
if ($conn->connect_error) {
  ...
  $sql = " UPDATE `customer_signin` SET `name`='$name',`mobile`='$mobile',
    `birthdate`='$birthdate',`gender`='$gender',`address`='$address' WHERE `email`='$email'";
